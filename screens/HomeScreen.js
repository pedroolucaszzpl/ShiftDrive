...
const HomeScreen = () => {
  ...
  const handleAddButtonPress = () => {
    navigation.navigate('AddTasks'); // Navega para a tela AddTasks quando o botão é pressionado
  };

  // Definindo a função handleProfilePress
  const handleProfilePress = () => {
    navigation.navigate('Profile'); // Navega para a tela Profile quando o avatar é pressionado
  };
    ...
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <View style={styles.headerRight}>
          ...
          {/* Navega para a tela de perfil quando o avatar é pressionado */}
